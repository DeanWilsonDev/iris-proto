...
// Builds the Iris IR -- this repo's own name (CLAUDE.md's "Chaos"/"Cosmos" terminology
...
// the `.iris` path today; this is a serializer over existing types, not a second parser.
//
